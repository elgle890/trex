...
function preload() {
    ...
    jump = loadSound('sons trex/jump.mp3');
    die = loadSound('sons trex/die.mp3');
    checkpoint = loadSound('sons trex/checkPoint.mp3');
}
...
function setup() {
    ...
    spriteRestart = createSprite(300, 150);
...
function criarCacto() {
    if(frameCount % 60 == 0) {
        ...
        console.log(cacto.velocityX);
        
        var numCacto = Math.round(random(1, 6));
        console.log(numCacto);
        switch(numCacto) {
            case 1:
...
function draw() {
   ...
   // console.log(trex.y);
    ...
    if(estado == JOGAR) {
        ...
        console.log('velocidade solo: ' + solo.velocityX);
